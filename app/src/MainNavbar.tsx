...
function MainNavbar() {
    ...
    return (
        <div className='main-nav-container'>
            ...
            <img onClick={handleClick} className='sm:hidden pr-6 cursor-pointer' src='/assets/shared/icon-hamburger.svg'></img>
            {
                width < breakpoint
                ? isShown &&
                (<div className='absolute top-0 left-0 h-screen w-screen' onClick={handleClick}>
                    <div className='absolute top-0 right-0 flex flex-col h-screen w-[20rem] bg-white bg-opacity-5 backdrop-blur-md z-20'>
                        <img className='self-end cursor-pointer m-10' onClick={handleClick} src='/assets/shared/icon-close.svg'></img>
